...
from sgp_structs import SGPStruct, SGPHeaders
import socket
from exceptions import ReceiveInterruptedError, ReceiveTimedOutError
from packet_parsers.header_validators import is_packet_type_valid, is_valid_header, \
    HEADER_DELIMITER
...
class BasicPacketParser(IPacketParser):
    ...
    def parse_packet(self, connection: socket.socket):
        try:
            ...
            raise ReceiveInterruptedError("The receive was interrupted") from e
        except socket.timeout as e:
            raise ReceiveTimedOutError("The receive timed out") from e
